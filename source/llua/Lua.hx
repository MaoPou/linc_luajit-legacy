...
extern class Lua {
	...
	static function pushlstring(L:cpp.RawPointer<Lua_State>, s:String, len:Int):Void;
	...
	static function _pushboolean(L:cpp.RawPointer<Lua_State>, b:Int):Void;

	static inline function pushboolean(L:cpp.RawPointer<Lua_State>, b:Bool):Void {
	...
	static function setglobal(L:cpp.RawPointer<Lua_State>, s:String):Int;

	@:native('lua_getglobal')
	static function getglobal(L:cpp.RawPointer<Lua_State>, s:String):Int;
	...
	static function _toboolean(L:cpp.RawPointer<Lua_State>, idx:Int):Int;

	static inline function toboolean(L:cpp.RawPointer<Lua_State>, idx:Int):Bool {
